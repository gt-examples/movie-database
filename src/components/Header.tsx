  ...
  return (
    <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10 border-b border-neutral-800 pb-6">
      ...
      <nav className="flex items-center gap-4">
        ...
        <Link href="/genres" className="text-sm text-neutral-400 hover:text-neutral-200 transition-colors">
          <T>Genres</T>
        </Link>
        <Link href="/watchlist" className="text-sm text-neutral-400 hover:text-neutral-200 transition-colors">
          <T>Watchlist</T>
        </Link>
        <LocaleSelector />
      </nav>
